...
<h1>Korozní zkoušky prováděné ve SVÚOM s.r.o.</h1>
...
$query = "SELECT * FROM norms WHERE typeid=2";
...
echo"<td width='150' height='40' align='center'><a href='index.php?zobraz=anotace2&lang=cz&idnum=".htmlspecialchars(stripslashes($row['idnum']))."'>".htmlspecialchars(stripslashes($row['idnorm']))."</a></td>";
...
$query = "SELECT * FROM engnorms WHERE typeid=2";
...
function tnkorzkmenu($lang) // menu vlevo
